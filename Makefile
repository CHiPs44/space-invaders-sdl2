...
# FILES.c = src/*.c
FILES.c = src/aliens.c src/debug.c src/event.c src/font.c src/graphics.c src/items.c src/main.c src/player.c src/saucer.c src/scene.c src/shields.c src/sprite.c
FILES.h = include/*.h
FILES.o = ${FILES.c:.c=.o}
